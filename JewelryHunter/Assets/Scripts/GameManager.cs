    ...
    void Update()
    {
        ...
        else if (PlayerController.gameState == "gameend")
        {
            if (Input.GetButtonDown("Jump"))
            {
                ...
                {
                    //Next
                    ChangeScene cs = nextButton.GetComponent<ChangeScene>();
                    if (cs != null)
                    {
                        cs.Load();
                    }
                }
                else if (restartButton.GetComponent<Button>().interactable)
                {
                    //Restart
                    ChangeScene cs = restartButton.GetComponent<ChangeScene>();
                    if (cs != null)
                    {
                        cs.Load();
                    }
